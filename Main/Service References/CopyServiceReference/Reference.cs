...
namespace Main.CopyServiceReference {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://schemas.microsoft.com/sharepoint/soap/", ConfigurationName="CopyServiceReference.CopySoap")]
    public interface CopySoap {
        ...
        uint CopyIntoItemsLocal(out Main.CopyServiceReference.CopyResult[] Results, string SourceUrl, string[] DestinationUrls);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        Main.CopyServiceReference.CopyIntoItemsResponse CopyIntoItems(Main.CopyServiceReference.CopyIntoItemsRequest request);
        
        // CODEGEN: Parameter 'Stream' requires additional schema information that cannot be captured using the parameter mode. The specific attribute is 'System.Xml.Serialization.XmlElementAttribute'.
        [System.ServiceModel.OperationContractAttribute(Action="http://schemas.microsoft.com/sharepoint/soap/GetItem", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        Main.CopyServiceReference.GetItemResponse GetItem(Main.CopyServiceReference.GetItemRequest request);
    }
    ...
    public partial class CopyIntoItemsRequest {
        ...
        public Main.CopyServiceReference.FieldInformation[] Fields;
        ...
        public CopyIntoItemsRequest(string SourceUrl, string[] DestinationUrls, Main.CopyServiceReference.FieldInformation[] Fields, byte[] Stream) {
    ...
    public partial class CopyIntoItemsResponse {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://schemas.microsoft.com/sharepoint/soap/", Order=1)]
        public Main.CopyServiceReference.CopyResult[] Results;
        
        public CopyIntoItemsResponse() {
        }
        
        public CopyIntoItemsResponse(uint CopyIntoItemsResult, Main.CopyServiceReference.CopyResult[] Results) {
    ...
    public partial class GetItemResponse {
        ...
        public GetItemResponse(uint GetItemResult, Main.CopyServiceReference.FieldInformation[] Fields, byte[] Stream) {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface CopySoapChannel : Main.CopyServiceReference.CopySoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class CopySoapClient : System.ServiceModel.ClientBase<Main.CopyServiceReference.CopySoap>, Main.CopyServiceReference.CopySoap {
        ...
        public uint CopyIntoItemsLocal(out Main.CopyServiceReference.CopyResult[] Results, string SourceUrl, string[] DestinationUrls) {
            return base.Channel.CopyIntoItemsLocal(out Results, SourceUrl, DestinationUrls);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Main.CopyServiceReference.CopyIntoItemsResponse Main.CopyServiceReference.CopySoap.CopyIntoItems(Main.CopyServiceReference.CopyIntoItemsRequest request) {
            return base.Channel.CopyIntoItems(request);
        }
        
        public uint CopyIntoItems(string SourceUrl, string[] DestinationUrls, Main.CopyServiceReference.FieldInformation[] Fields, byte[] Stream, out Main.CopyServiceReference.CopyResult[] Results) {
            Main.CopyServiceReference.CopyIntoItemsRequest inValue = new Main.CopyServiceReference.CopyIntoItemsRequest();
            inValue.SourceUrl = SourceUrl;
            inValue.DestinationUrls = DestinationUrls;
            inValue.Fields = Fields;
            inValue.Stream = Stream;
            Main.CopyServiceReference.CopyIntoItemsResponse retVal = ((Main.CopyServiceReference.CopySoap)(this)).CopyIntoItems(inValue);
            Results = retVal.Results;
            return retVal.CopyIntoItemsResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Main.CopyServiceReference.GetItemResponse Main.CopyServiceReference.CopySoap.GetItem(Main.CopyServiceReference.GetItemRequest request) {
            return base.Channel.GetItem(request);
        }
        
        public uint GetItem(string Url, out Main.CopyServiceReference.FieldInformation[] Fields, out byte[] Stream) {
            Main.CopyServiceReference.GetItemRequest inValue = new Main.CopyServiceReference.GetItemRequest();
            inValue.Url = Url;
            Main.CopyServiceReference.GetItemResponse retVal = ((Main.CopyServiceReference.CopySoap)(this)).GetItem(inValue);
